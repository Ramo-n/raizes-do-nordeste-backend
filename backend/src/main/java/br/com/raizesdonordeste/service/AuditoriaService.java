...
public class AuditoriaService {
    ...
    public RegistroAuditoria registrar(TipoOperacaoSensivel tipo, String autor, String detalhes, String justificativa, Long pedidoId, Long clienteId) {
    ...
    public List<RegistroAuditoria> listar(TipoOperacaoSensivel tipo) {
        return tipo == null ? repository.findAllByOrderByDataHoraDesc() : repository.findByTipoOrderByDataHoraDesc(tipo);
    }
