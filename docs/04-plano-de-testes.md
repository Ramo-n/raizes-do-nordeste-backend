...
| CT04 | RF17/RF06/RF11 | Callback confirma o pagamento | Pedido `PAGO`, estoque baixado, pontos acumulados |
| CT05 | RF18 | Callback reentregue (duplicado) | Nenhum efeito adicional (idempotência) |
| CT06 | RF17/RF18 | Callback recusa o pagamento | Pedido `PAGAMENTO_RECUSADO`, estoque intacto |
...
| CT13 | RF15 | Anonimizar cliente | Nome/e-mail/data de nascimento removidos irreversivelmente; auditoria `ANONIMIZACAO` |
